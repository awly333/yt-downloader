...
1. 在 Chrome 或 Edge 中安装 **[Get cookies.txt LOCALLY](https://chromewebstore.google.com/detail/get-cookiestxt-locally/cclelndahbckbenkjhflpdbgdldlbecc)** 扩展（Firefox 用户可安装 [对应版本](https://addons.mozilla.org/firefox/addon/cookies-txt/)）。
